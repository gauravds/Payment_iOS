...
// PayeezySDK
#define COCOAPODS_POD_AVAILABLE_PayeezySDK
#define COCOAPODS_VERSION_MAJOR_PayeezySDK 2
#define COCOAPODS_VERSION_MINOR_PayeezySDK 0
#define COCOAPODS_VERSION_PATCH_PayeezySDK 0
